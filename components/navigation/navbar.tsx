...
export default function Navbar() {
  ...
  return (
    <div className='w-full flex flex-row justify-between lg:justify-end items-center gap-5 px-5 py-3 border-b bg-white dark:bg-black'>
        ...
        <Link href='/' className='md:hidden h-10 w-10'>
            <Image  
                alt='DormHive' 
                src={Logo} 
                width={0}
