...
export default function EventList(props: any) {
  ...
  const [previousEvents, setPreviousEvents] = React.useState<any>(
    previousData.slice(0, 3)
  );
  const [upcomingEvents, setUpcomingEvents] = React.useState<any>(
    upcomingData.slice(0, 3)
  );
    ...
    <div className="flex flex-col gap-3">
      <div className="flex flex-row justify-between items-center">
        <div className="flex gap-3 items-center">
          ...
          >
            {expandUpcoming ? "+ See All" : "- See Less"}
          </button>
        </div>
        <Button size={"sm"}>
      ...
      <div className="flex flex-wrap gap-3">
        {upcomingEvents.map((event: any, index: number) => (
          <div
            key={index}
            className="col-span-6 sm:col-span-3 xl:col-span-2 w-full sm:w-[200px]"
          >
      ...
      <div className="flex gap-3 items-center pt-5">
        ...
        >
          {expandPrevious ? "+ See All" : "- See Less"}
        </button>
      </div>
